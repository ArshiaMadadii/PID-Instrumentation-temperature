...
_0x4:
	.DB  0xCD,0xCC,0xCC,0x3C
_0x5:
	.DB  0x82,0xA8,0xFB,0x36
_0x6:
	.DB  0x0,0x0,0x80,0x3F
_0x0:
	.DB  0x54,0x3D,0x25,0x33,0x2E,0x31,0x66,0x20
	.DB  0x53,0x50,0x3D,0x25,0x32,0x2E,0x31,0x66
	.DB  0x20,0xA,0x4B,0x70,0x3D,0x25,0x66,0x20
	.DB  0xA,0x4B,0x69,0x3D,0x25,0x66,0x20,0xA
	.DB  0x4B,0x64,0x3D,0x25,0x66,0x0
_0x2000003:
	.DB  0x80,0xC0
_0x2020000:
...
; 0000 0033             iterm=(ki*error)+last_iterm;
	...
	CALL __MULF12
	LDS  R26,_last_iterm
	LDS  R27,_last_iterm+1
	LDS  R24,_last_iterm+2
	LDS  R25,_last_iterm+3
	CALL __ADDF12
	STS  _iterm,R30
	STS  _iterm+1,R31
	STS  _iterm+2,R22
...
_0xB:
	CALL SUBOPT_0x4
	STS  _last_iterm,R30
	STS  _last_iterm+1,R31
	STS  _last_iterm+2,R22
	STS  _last_iterm+3,R23
